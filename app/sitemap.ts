...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = process.env.NEXT_PUBLIC_APP_URL || 'https://luxeinteriors.com';
  ...
  return [
    ...
    { url: `${baseUrl}/ai-visualizer`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
  ];
}
